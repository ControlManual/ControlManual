...
class ConsoleWrapper:
    ...
    def __init__(self):
        ...
        self.render(layout["small"], "row", make_panel("directory"), make_panel("log"))
    ...
    def render(
        self, layout: Layout, typ: Literal["row", "column"], *rows: Optional[Layout]
    ):
    ...
    def success(
        self, message: Any, *args: Tuple[str], **kwargs: Dict[str, str]
    ) -> None:
