...
API schema* schema_new(data* name, data* description, param** params, size_t params_len);
...
#define RAW_FLAG(name, shorthand, desc, convert) param_new(STACK_DATA(#name), STACK_DATA(desc), NULL, true, true, false, NULL, convert, STACK_DATA(shorthand), false, 0, NULL)
#define RAW_KWARG(name, shorthand, desc, tp, default, convert) param_new(STACK_DATA(#name), STACK_DATA(desc), &tp, false, true, false, STACK_DATA(EXPR(default)), convert, STACK_DATA(shorthand), false, 0, NULL)
#define RAW_ARG(name, desc, tp, convert) param_new(STACK_DATA(#name), STACK_DATA(desc), &tp, false, false, true, NULL, convert, NULL, false, 0, NULL)
#define RAW_DEFAULT_ARG(name, desc, tp, expr, convert) param_new(STACK_DATA(#name), STACK_DATA(desc), &tp, false, false, false, STACK_DATA(EXPR(expr)), convert, NULL, false, 0, NULL)
