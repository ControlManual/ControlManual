...
def get_path(current_path: PathLike, path: PathLike, file: bool = False) -> Optional[str]:
...
def get_path_inverted(current_path: PathLike, path: PathLike, file: bool = False) -> Optional[str]:
